      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-400">Add, edit, or remove artists</p>
            </div>
            <Link
        ...
        {artists.length === 0 ? (
          <div className="text-center py-12">
            <h2 className="text-white text-xl mb-2">No artists found</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {artists.map((artist) => (
              ...
              >
                <div className="relative w-full aspect-square mb-4 rounded-full overflow-hidden bg-gray-800">
                  <Image
                    src={artist.imageUrl}
                    alt={artist.name}
                    fill
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <p className="text-gray-500 text-xs">
                    Created {artist.createdAt.toLocaleDateString()}
                  </p>
                </div>
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    ...
                    {deleting === artist.id ? "Deleting..." : "Delete"}
                  </button>
                </div>
              </div>
            ))}
